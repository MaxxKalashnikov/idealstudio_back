--gets appointment details according to username 
CREATE OR REPLACE FUNCTION get_appointment_details_by_username(input_username VARCHAR)
RETURNS TABLE (
    appointment_id INT,
    timeslot_date DATE,
    start_time TIME,
...
BEGIN
    ...
    JOIN 
        user_account u ON c.user_account_id = u.user_account_id
    WHERE 
